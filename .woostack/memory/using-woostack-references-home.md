---
name: using-woostack-references-home
type: convention
scope: skills/using-woostack/references/**
...
relative cross-link; it is NOT indexed in `using-woostack/SKILL.md`.
Discoverability = ≥1 consumer cross-link, not a SKILL index entry.
Cross-link, never inline-duplicate the rules. See [[review-add-angle-sites]].
