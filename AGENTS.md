...
- Keep the docs site in sync. When a change alters what an **authored** [`site/`](site/) page
  ...
  site still builds.
- Do not move or rename any of the twenty-five installed `SKILL.md` files (the twenty-two public command/adoption
...
- Maintainer-only skill behavior and trigger evaluation tooling (not installed or routed to
  consumers): [`tooling/evals/`](tooling/evals/)
