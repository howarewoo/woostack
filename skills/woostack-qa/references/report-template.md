...
- **GitHub context:** {{none | exact verified canonical PR, issue, or Project URL and read receipt}}
...
- Optional GitHub reference: {{none | exact canonical GitHub URL}}
- GitHub read-back: {{n/a | receipt ID and timestamp}}
