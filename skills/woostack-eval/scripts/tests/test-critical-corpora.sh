...
const requiredContractProofs = {
  ...
  'woostack-audit': {
    ...
    'artifact-free remediation routes through fix approval': [['fix-handoff-ready'], ['linear-not-required'], ['report-remains-evidence'], ['fix-dispatched'], ['no-local-development-fallback']],
  ...
  'woostack-respond': {
    ...
    'remediation routes without a Linear prerequisite': [['fix-handoff-ready'], ['linear-is-optional'], ['safe-report-survives'], ['remediation-routed-to-fix'], ['classification-does-not-mutate-repository'], ['no-local-fix-spec-plan']],
    'verified artifact context preserves repository authority boundary': [['handoff-ready'], ['artifact-linked'], ['stable-issue-id-retained'], ['native-issue-id-retained'], ['artifact-read-back-is-complete'], ['repository-handoff-authorized'], ['approval-is-authority'], ['assignment-not-required'], ['handoff-never-creates-local-authority']],
    'unknown artifact outcome blocks synchronization without blocking repository work': [['artifact-sync-blocks'], ['ambiguous-recovery-reason'], ['stable-id-is-preserved'], ['no-duplicate-create'], ['no-replacement-uuid'], ['no-artifact-is-linked'], ['repository-work-remains-independent'], ['no-local-recovery-authority']],
  },
  'woostack-visualize': {
