...
const requiredContractProofs = {
  ...
  'woostack-sweep': {
    ...
    'nit-only rounds advance without rereview': [['nit-addressed'], ['no-nit-rereview']],
...
const approvedCorpusContracts = {
  ...
  'woostack-build': corpusContract(7, '9c6391095c9558db25398d268341636319b26a9c6667ebf0e7adb2df2888b658'),
  'woostack-plan': corpusContract(5, 'a77703ae7e41168bd90c1561e0099574fadb608e781f0a2eb60aba135a6b6615'),
  ...
  'woostack-init': corpusContract(24, '0bd8cd34815a0cf7a35eb5098c7d77cf96f068a5ad54dc7df1122f0f77d2bff9'),
  'woostack-doctor': corpusContract(3, 'b855c2a1907ca899725809fe94b74b2ef49eea96efa9f2ce3602dbeb05abe769'),
