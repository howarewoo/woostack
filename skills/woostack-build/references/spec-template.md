...
> **Angle pre-flight.** Before finalizing ACs, walk the spec lens of `skills/woostack-harden/references/angle-preflight.md`: capture each implicated angle — security, observability, api, data, edge/error — as a §6 error path or a §7 error/edge case.
