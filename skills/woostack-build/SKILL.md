...
issue-reference/nullable-parent preflight, native project/team identity, drift/failure recovery, artifact
...
retains run artifacts, does not close or mutate a mirrored Linear project, and does not dispatch
