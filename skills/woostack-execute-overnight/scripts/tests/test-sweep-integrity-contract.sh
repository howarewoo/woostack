...
checks={
 ...
 "no implicit Linear":r"Without an exact artifact flag, make no Linear call",
 ...
 "failure isolation":r"task-local failure.*track-local review or submission failure.*shared invariant failure.*provider/artifact failure.*unknown mutation outcome",
 ...
 "artifact narrow":r"Except for the workflow-owned fix/build project closure above, do not mutate assignee, delegate, native status, relations, membership, or archival state",
