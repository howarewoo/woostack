...
require_text "README.md" 'This command registers twenty-three public command/adoption skills and three bundled supporting'
require_text "README.md" 'skills at twenty-six fixed `SKILL.md` locations.'
require_text "README.md" '[/woostack-change](skills/woostack-change/SKILL.md)'
require_text "README.md" 'Ships a bounded enhancement or refactor through one standalone Linear issue and one PR.'
