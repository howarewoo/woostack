...
require_text "skills/woostack-change/SKILL.md" '[`woostack-tdd` kernel](../woostack-tdd/SKILL.md) through red → green → refactor.'
...
require_text "skills/woostack-change/SKILL.md" 'plus all staged, unstaged, and untracked changes.'
require_text "skills/woostack-change/SKILL.md" 'PASS'
require_text "skills/woostack-change/SKILL.md" 'BLOCKED'
require_text "skills/woostack-change/SKILL.md" 'Every receipt names the branch, resolved base ref and commit, HEAD commit'
...
require_text "skills/woostack-commit/SKILL.md" 'binary-safe base-to-HEAD state'
...
require_text "README.md" '4. **Bounded Non-Bug Changes** → [/woostack-change](skills/woostack-change/SKILL.md)'
...
require_text "CONTRIBUTING.md" 'Keep the twenty-two public command/adoption skills and all twenty-five fixed `SKILL.md` files'
