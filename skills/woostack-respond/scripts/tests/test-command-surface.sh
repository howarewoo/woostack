...
assert_contains "$agents" 'twenty-three skills' "registered count updated"
assert_contains "$agents" 'twenty-six `SKILL.md` files' "physical count updated"
...
assert_contains "$contributing" '`woostack-respond`, and `woostack-eval`' "contributor public list registers response"
