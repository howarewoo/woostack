...
- **Cross-PR memory** (optional): /tmp/pr-review/memory.md — team-curated markdown of gotchas and previously-accepted issues. Absent when the repo has no `.woostack/memory.md`.
