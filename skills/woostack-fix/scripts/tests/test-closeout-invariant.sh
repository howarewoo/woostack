...
assert_contains "$body" "purpose of execution approval" "fix records explicit approval"
...
assert_contains "$body" 'separate terminal `acceptance`' "fix distinguishes terminal acceptance"
