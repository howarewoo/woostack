...
runtime, while template presence and repair apply only to the tracked base file. OMP uses existing
host-owned role-agent selection; repository model settings cannot create aliases or a model catalog.
