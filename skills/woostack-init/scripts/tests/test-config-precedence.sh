...
printf '{"artifacts":{"provider":"github"}}\n' >"$repo/.woostack/config.json"; rm -f "$repo/.woostack/config.local.json"
bash "$RESOLVER" "$repo" >/dev/null
printf '{"artifacts":{"provider":"github","github":{"owner":null}}}\n' >"$repo/.woostack/config.json"
must_fail "$repo" ".woostack/config.json" "explicit null owner is not treated as absent"
printf '{"artifacts":{"provider":"github","github":null}}\n' >"$repo/.woostack/config.json"
must_fail "$repo" ".woostack/config.json" "explicit null github policy is not treated as absent"
...
must_fail "$repo" ".woostack/config.json" "invalid owner fails"
...
must_fail "$repo" ".woostack/config.json" "invalid ownerType fails"
...
must_fail "$repo" ".woostack/config.json" "invalid visibility fails"
...
must_fail "$repo" ".woostack/config.json" "unknown key in github config fails"
...
must_fail "$repo" ".woostack/config.local.json" "invalid local github owner override attributes to local config"
