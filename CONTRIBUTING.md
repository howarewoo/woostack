...
| Change maintainer skill evaluation | `tooling/evals/SKILL.md`, `tooling/evals/references/`, `tooling/evals/scripts/` |
...
- **Preserve the public surface.** Artifact backends do not create skills or command-routing rows.
  Keep the twenty-two public command/adoption skills and all twenty-five installed `SKILL.md` files
