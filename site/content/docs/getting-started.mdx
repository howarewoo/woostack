...
<Callout type="info">
  ...
  requests, reviews, and merges. Linear records plans only for an exact caller-selected artifact or
  explicit persistence request and never authorizes repository work.
</Callout>
