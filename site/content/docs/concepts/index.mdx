---
title: Core concepts
description: "woostack's two big ideas: the gated build loop and context economy, plus the operational surfaces around them."
---
...
mechanisms: recall by scope, compute in the shell, and isolate in subagents. Two operational
