...
approval, approval-before-save, native read-back compared by the shared provider-presentation
canonical fingerprint before receipt, stable identity mapping,
