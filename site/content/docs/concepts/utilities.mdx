...
explicit approval; its evidence and reports are transient, and it never edits the target skill.
...
| [woostack-eval](/docs/skills/woostack-eval) | Runs approved behavior and trigger corpora as isolated candidate/baseline comparisons. | approved tracked corpus files only; transient evidence and reports; no target skill edit | `/woostack-eval <skill-path> [--behavior\|--triggers\|--all]` |
