...
and native content/graph read-back is compared by the shared provider-presentation canonical
fingerprint before the matching receipt can clear the gate.
