...
| --- | --- | --- |
| [`artifacts`](/docs/configuration/artifacts) | Init, Build, Fix, Plan, Execute, and selected artifact-aware workflows | Selects local storage or optional Linear or Plane mirroring. |
