...
through bundled workers. omp ignores `.woostack/config.json` model settings and owns role
configuration, concrete model identity, provider credentials, and fallback.
