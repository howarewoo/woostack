...
| `linear.projectStatuses` | complete name map | required | Native project-status name for each coarse category: `backlog`, `planned`, `started`, `paused`, `completed`, and `canceled`. |
