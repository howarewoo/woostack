...
Neither the planning chat nor Orchestrate has merge authority. Missing Plan relationships must be
reported rather than claimed, but do not make a clear declared tracker categorically non-executable.
