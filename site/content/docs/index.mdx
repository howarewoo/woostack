...
- **Agent- & model-agnostic:** explicitly supports [omp, opencode, Claude Code, Codex,
...
- **Universal harness and model support:** the same skill logic should work in any harness.
  [Six harnesses are explicitly supported](/docs/harnesses); unsupported harnesses may lack native
  capabilities such as reliable per-call model selection.
